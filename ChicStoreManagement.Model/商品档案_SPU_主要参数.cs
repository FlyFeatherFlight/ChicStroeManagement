...
public partial class 商品档案_SPU_主要参数
{
    public 商品档案_SPU_主要参数()
    {
        this.商品档案_SPU_主要参数_可选项 = new HashSet<商品档案_SPU_主要参数_可选项>();
    }
    ...
    public virtual ICollection<商品档案_SPU_主要参数_可选项> 商品档案_SPU_主要参数_可选项 { get; set; }
}
